...
Generated with the factory Azure image deployment (`/opt/fleet/lib/gen-image.sh`), 2026-08-28. The selected source and exact prompt live in `assets/src/hero-map.json`; output is optimized to WebP. Generated imagery is original for this product under the project’s MIT distribution.
